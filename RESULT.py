...
CANDIDATE_CSV = r"C:\Users\AshutoshMishra\Downloads\CTGD2025\CTGD2025\candidates_final.csv"
VACANCY_CSV   = r"C:\Users\AshutoshMishra\Downloads\CTGD2025\CTGD2025\vacancy_table_raw.csv"
...
def run_all_sanity_checks(candidate_df, vacancy_df, cutoff_df):
    c_ok   = check_candidate_df(candidate_df)
    v_ok   = check_vacancy_df(vacancy_df)
    cut_ok = check_cutoff_df(cutoff_df)

    _header("FINAL SUMMARY")
    print(f"    candidate_df  : {'PASSED' if c_ok   else 'FAILED'}")
    print(f"    vacancy_df    : {'PASSED' if v_ok   else 'FAILED'}")
    print(f"    cutoff_df     : {'PASSED' if cut_ok else 'FAILED'}")

    if c_ok and v_ok and cut_ok:
        print("\n    All checks passed. Safe to proceed with result processing.")
    else:
        print("\n    Fix the issues above before running result processing!")

    return c_ok and v_ok and cut_ok
...
print("Candidates with empty catsel after processing:", candidate_df[candidate_df['catsel'] == ''].shape[0])
    ...
    for idx, candidate in filtered_candidates.iterrows():
        ...
        for post in post_preference.split(','):
            ...
            for category in catsel:
                ...
                # Post H or G — centralised (state 39)
                if str(post) in ['H', 'G']:
...
print("Left vacancy after first run:", updated_vacancy_df['current'].sum())
print("Total initial vacancy:", updated_vacancy_df['initial'].sum())
print("Candidates allocated:", cand[cand['allocated_category'].notnull()].shape[0])
print("Total allocated (hc):", updated_vacancy_df['allocated'].sum())
...
print("Final allocated_hc_prev:", updated_vacancy_df['allocated_hc_prev'].sum())
print("Final allocated_hc:", updated_vacancy_df['allocated_hc'].sum())


# =============================================================================
# FIND LOWEST MARKS PER VACANCY SLOT
# =============================================================================
...
print("Total allocated in final vacancy:", final_vacancy_df['allocated'].sum())


# =============================================================================
# FINAL VACANCY ADJUSTMENTS
# =============================================================================
...
print("  allocated_candidates_ctgd2025.csv")
print("  only_allocated_candidates.csv")
print("  allocated_vacancy_ctgd.csv")
